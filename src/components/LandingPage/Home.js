...
function Home() {
    ...
    const fetchData = async () => {
        ...
        if (jsonData?.data?.cards[5].card?.card?.gridElements?.infoWithStyle?.restaurants) {
            ...
            setListOfResturnts(jsonData?.data?.cards[4]?.card?.card?.gridElements?.infoWithStyle?.restaurants);
            // console.log(jsonData?.data?.cards[4]?.card?.card?.gridElements?.infoWithStyle?.restaurants);
            setFilterResturants(jsonData?.data?.cards[4]?.card?.card?.gridElements?.infoWithStyle?.restaurants);
        }
    }
